...
const CategoryItems = () => {
    ...
    const categoryItems = itemsByCity?.filter((item) => item.category === category)
    ...
    return (
        ...
        <div className='flex flex-col gap-3 p-6 sm:px-14'>
            <h1 className='text-3xl text-orange-500 font-semibold'>Here All Foods of {category} Category</h1>
